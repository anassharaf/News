                                ...
                                <div class="table-responsive">
                                    <table class="table mg-b-0 text-md-nowrap">
                                        ...
                                        <tr>
                                            ...
                                            @if($contact->status == 0)
                                                <td><span class="badge badge-danger">Not Answered</span></td>
                                            @else
                                                <td><span class="badge badge-success">Answered</span></td>
                                            @endif
                                            <td>
                                                <a class="btn btn-primary" href="{{route('admin.contacts.show',[$contact->id])}}" title="View"><i class="fa fa-eye"></i></a>
                                                <form action="{{route('admin.contacts.delete')}}" method="post" style="display: inline-block">
                                                    @csrf
                                                    @method('DELETE')
