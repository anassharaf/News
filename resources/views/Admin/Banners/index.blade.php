                                ...
                                <div class="table-responsive">
                                    <table class="table mg-b-0 text-md-nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$banner->height}}</td>
                                            <td>
                                                <a class="btn btn-success" href="{{route('admin.banners.edit',[$banner->id])}}" title="Edit"><i class="fa fa-edit"></i></a>
                                                <form action="{{route('admin.banners.delete')}}" method="post" style="display: inline-block">
                                                    @csrf
                                                    @method('DELETE')
